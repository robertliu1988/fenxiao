...
CREATE TABLE `#__store_joinin` (
  ...
  PRIMARY KEY (`member_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='店铺入驻表';
...
(25, 7, '', 1, 255, '合作及洽谈', '<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 好商城V4希望与服务代理商、合作伙伴并肩合作，携手开拓日益广阔的网络购物软件市场。如果您拥有好的建议，拥有丰富渠道资源、拥有众多目标客户、拥有相应的市场资源，并希望与好商城V4进行深度业务合作， 欢迎成为好商城V4业务合作伙伴，请联系。</p>\r\n<p>&nbsp;</p>\r\n<p><strong>公司名称</strong>： 天津市网城天创科技有限责任公司 <br />\r\n<strong>通信地址</strong>： 中国深圳 <br />\r\n<strong>邮政编码</strong>： 518000 <br />\r\n<strong>电话</strong>： 400-800-8000 <br />\r\n<strong>商务洽谈</strong>： 86-0755-3585310 <br />\r\n</p>', 1435672310),
...
(35, 1, 'http://www.33hao.com/', 1, 1, '火爆销售中', '火爆销售中<br />', 1435672310),
...
INSERT INTO `#__seo` (`id`, `title`, `keywords`, `description`, `type`) VALUES (1, '{sitename} - 程序来源于好商城V4-www.33hao.com', '好商城V4,PHP商城系统,好商城V4商城系统,多用户商城系统,电商ERP,电商CRM,电子商务解决方案', '好商城V4专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'index'),
(2, '{sitename} - 团购', '好商城V4,{sitename}', '好商城V4专注于研发符合时代发展需要的电子商务商城系统，以专业化的服务水平为企业级用户提供B(2B)2C【B2B2C】电子商务平台解决方案，全力打造电商平台专项ERP(CRM)系统、ERP(RFID)系统等，引领中国电子商务行业企业级需求的发展方向。咨询电话：400-611-5098', 'group'),
(3, '{sitename} - {name}', '好商城V4,{name},{sitename}', '好商城V4,{name},{sitename}', 'group_content'),
(4, '{sitename} - 品牌', '好商城V4,{sitename}', '好商城V4,{sitename}', 'brand'),
(5, '{sitename} - {name}', '好商城V4,{sitename},{name}', '好商城V4,{sitename},{name}', 'brand_list'),
(7, '{sitename} - {name}', '好商城V4,{sitename},{name}', '好商城V4,{sitename},{name}', 'coupon_content'),
(8, '{sitename} - 积分商城', '好商城V4,{sitename}', '好商城V4,{sitename}', 'point'),
(9, '{sitename} - {name}', '好商城V4,{sitename},{key}', '好商城V4,{sitename},{description}', 'point_content'),
(10, '{sitename} - {article_class}', '好商城V4,{sitename}', '好商城V4,{sitename}', 'article'),
(11, '{sitename} - {name}', '好商城V4,{sitename},{key}', '好商城V4,{sitename},{description}', 'article_content'),
(12, '{sitename} - {shopname}', '好商城V4,{sitename},{key}', '好商城V4,{sitename},{description}', 'shop'),
(13, '{name} - {sitename}', '好商城V4,{sitename},{key}', '好商城V4,{sitename},{description}', 'product'),
(14, '看{name}怎么淘到好的宝贝-{sitename}', '好商城V4,{sitename},{name}', '好商城V4,{sitename},{name}', 'sns');
...
(122, 1, 'array', 'banner', '', '横幅图片'),
(123, 2, 'array', 'banner', '', '横幅图片'),
(124, 3, 'array', 'banner', '', '横幅图片'),
(125, 4, 'array', 'banner', '', '横幅图片'),
(126, 5, 'array', 'banner', '', '横幅图片'),
(127, 6, 'array', 'banner', '', '横幅图片'),
(128, 7, 'array', 'banner', '', '横幅图片'),
(129, 8, 'array', 'banner', '', '横幅图片'),
(130, 0, 'array', 'channel_tit', '', '频道中部标题'),
(131, 122, 'array', 'channel_act', '', '频道中部活动'),
(132, 122, 'array', 'recommend_list', '', '频道中部商品'),
(133, 122, 'array', 'adv_a', '', '频道中部广告1'),
(134, 122, 'array', 'adv_b', '', '频道中部广告2'),
(135, 122, 'array', 'adv_c', '', '频道中部广告3'),
(136, 123, 'array', 'channel_category', '', '频道顶部分类'),
(137, 123, 'array', 'channel_slide', '', '频道顶部切换'),
(138, 123, 'array', 'channel_adv', '', '频道顶部广告'),
(139, 1, 'array', 'recommends_list', '', '热卖促销'),
(140, 2, 'array', 'recommends_list', '', '热卖促销'),
(141, 3, 'array', 'recommends_list', '', '热卖促销'),
(142, 4, 'array', 'recommends_list', '', '热卖促销'),
(143, 5, 'array', 'recommends_list', '', '热卖促销'),
(144, 6, 'array', 'recommends_list', '', '热卖促销'),
(145, 7, 'array', 'recommends_list', '', '热卖促销'),
(146, 8, 'array', 'recommends_list', '', '热卖促销'),
(147, 1, 'array', 'banner', '', '横幅图片'),
(148, 2, 'array', 'banner', '', '横幅图片'),
...
(155, 124, 'array', 'channel_tit', '', '频道中部标题'),
(156, 124, 'array', 'channel_act', '', '频道中部活动'),
(157, 124, 'array', 'recommend_list', '', '频道中部商品'),
(158, 124, 'array', 'adv_a', '', '频道中部广告1'),
(159, 124, 'array', 'adv_b', '', '频道中部广告2'),
(160, 124, 'array', 'adv_c', '', '频道中部广告3');
...
INSERT INTO  `#__mb_payment` (`payment_id`, `payment_code`, `payment_name`, `payment_config`, `payment_state`) VALUES ('1', 'alipay', '支付宝手机支付', '', '0');
INSERT INTO  `#__mb_payment` (`payment_id`, `payment_code`, `payment_name`, `payment_config`, `payment_state`) VALUES ('2', 'wxpay_jsapi', '微信支付JSAPI', '', '0');
...
CREATE TABLE  `#__mb_seller_token` (
  ...
  PRIMARY KEY (`token_id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='客户端商家登录令牌表';
...
(1047, '首页中上部banner', '好商城V4', 0, 2, 1, 1200, 90, 100, 1, 0, '04891676111561966.png'),
(1048, '顶部logo边广告', '', 0, 2, 1, 100, 70, 0, 0, 0, '05048168915006375.gif'),
(1049, '首页右侧广告', '首页右侧广告', 0, 1, 1, 230, 165, 0, 0, 0, '05057671828128355.png');
...
(935, 11, '首页物流自提banner', 'a:2:{s:7:"adv_pic";s:21:"04876370813599010.gif";s:11:"adv_pic_url";s:41:"v3.33hao.com/delivery/index.php?act=login";}', 1434211200, 1749312000, 0, 0, '', 0, 1, '', 0),
(936, 1047, '好商城V4', 'a:2:{s:7:"adv_pic";s:21:"04891676111561966.png";s:11:"adv_pic_url";s:13:"www.33hao.com";}', 1435766400, 1753891200, 0, 0, '', 0, 1, '', 0);
...
INSERT INTO `#__setting`  (`name`, `value`) VALUES ('points_signin', '5');
...
ALTER TABLE `#__member` add `member_wxopenid` varchar(100) DEFAULT NULL COMMENT '微信互联openid';
