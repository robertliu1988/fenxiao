...
<div class="page">
  <form method="post" name="form1" id="form1" action="<?php echo urlAdmin('fenxiao_goods', 'goods_verify');?>">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="rewrite_enabled"  class="cb-enable selected" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
            ...
            <input id="rewrite_disabled" name="verify_state" value="3" type="radio"></td>
          <td class="vatop tips">
