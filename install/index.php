...
$html_title = '33hao.com 好商城V4电商系统 安装程序';

$html_header = <<<EOF
<div class="header">
  <div class="layout">
    <div class="title">
      <h5>33hao.com 好商城V4电商系统 安装程序</h5>
      <h2>系统安装向导</h2>
    </div>
    <div class="version">版本: V4.1 2016.02.21</div>
  </div>
</div>
...
$html_footer = <<<EOF
<div class="footer">
  <h6><a href="http://www.33hao.com" target="_blank">程序来源于 好商城 33hao.com</a></h6>
</div>
EOF;
