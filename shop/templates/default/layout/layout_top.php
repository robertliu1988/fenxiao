    ...
    <div class="user-login-box" nctype="barLoginBox" style="display:none;"> <i class="arrow"></i> <a href="javascript:void(0);" class="close-a" nctype="close-barLoginBox" title="关闭">X</a>
      <form id="login_form" method="post" action="index.php?act=login&op=login" onsubmit="ajaxpost('login_form', '', '', 'onerror')">
        ...
        <div class="bottom">
          ...
          <a href="<?php echo SHOP_SITE_URL;?>/index.php?act=login&op=register&ref_url=<?php echo urlencode($output['ref_url']);?>" target="_blank">注册新用户</a>
...
<div class="public-top-layout w">
  <div class="topbar wrapper">
    <div class="user-entry">
      ...
      <?php }else{?>
      <?php echo $lang['welcome_to_site'];?> <a href="<?php echo BASE_SITE_URL;?>" title="<?php echo $lang['homepage'];?>" alt="<?php echo $lang['homepage'];?>"><?php echo $output['setting_config']['site_name']; ?></a>
	  <a href="<?php echo SHOP_SITE_URL;?>/index.php?act=login&op=index&ref_url=<?php echo urlencode($output['ref_url']);?>">请登录</a></span> <span><a href="<?php echo SHOP_SITE_URL;?>/index.php?act=login&op=register&ref_url=<?php echo urlencode($output['ref_url']);?>">免费注册</a></span>
	...
	<span class="other">
      ...
      <a href="javascript:void(0);" onclick="ajax_form('weixin_form', '微信账号登录', '<?php echo SHOP_SITE_URL;?>/index.php?act=connect_wx&op=index', 360);" title="微信账号登录" class="wx"><i></i></a><?php } ?>
      </span>
      <?php } ?>
      <?php }?>
    </div>
