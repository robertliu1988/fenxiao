...
class fenxiao_member_gradeModel{
	/**
	 * 列表
	 *
	...
	public function getGradeList($condition = array()){
		...
		$param = array();
		$param['table'] = 'fenxiao_member_grade';
	...
	private function _condition($condition){
		...
		if ($condition['fmg_id'] != ''){
			$condition_str .= " and fenxiao_member_grade.fmg_id = '". $condition['fmg_id'] ."'";
		}
	...
	public function add($param){
		...
		if (is_array($param)){
			...
			$result = Db::insert('fenxiao_member_grade',$tmp);
			return $result;
		}else {
			return false;
		}
	...
	public function update($param){
		...
		if (is_array($param)){
			...
			$result = Db::update('fenxiao_member_grade',$tmp,$where);
			return $result;
		}else {
			return false;
		}
	...
	public function del($id){
		if (intval($id) > 0){
			...
			$result = Db::delete('fenxiao_member_grade',$where);
			return $result;
		}else {
			return false;
		}
	...
	public function getGradeShopList($condition,$page=''){
		$condition_str = $this->_condition($condition);
		$param = array(
					'table'=>'fenxiao_member_grade,store',
					'field'=>'fenxiao_member_grade.*,store.*',
					'where'=>$condition_str,
					'join_type'=>'left join',
					'join_on'=>array(
						'fenxiao_member_grade.fmg_id = store.grade_id',
					)
				);		
