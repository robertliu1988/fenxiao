    ...
    var e = function(e) {
        ...
        function n(e) {
            ...
            if (!$.isEmptyObject(e.goods_info)) {
                var a = e.goods_info;
                var t = '<div class="nctouch-chat-product"> <a href="' + WapSiteUrl + "/tmpl/product_detail.html?goods_id=" + a.goods_id + '" target="_blank"><div class="goods-pic"><img src="' + a.pic24 + '" alt=""/></div><div class="goods-info"><div class="goods-name">' + a.goods_name + '</div><div class="goods-price">￥' + a.goods_promotion_price + "</div></div></a> </div>";
                $("#chat_msg_html").append(t)
            }
