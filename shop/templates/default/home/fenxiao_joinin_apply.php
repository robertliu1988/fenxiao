...
<div class="breadcrumb"><span class="icon-home"></span><span><a href="<?php echo SHOP_SITE_URL;?>">首页</a></span> <span class="arrow">></span> <span>商家分销申请</span> </div>
<div class="main">
  <div class="sidebar">
    <div class="title">
      <h3>商家分销申请</h3>
  ...
  <div class="right-layout">
    ...
    <div class="joinin-concrete">
      <?php require('fenxiao_joinin_apply.'.$output['sub_step'].'.php'); ?>
    </div>
  </div>
</div>
